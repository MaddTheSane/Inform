...
/// URL of the file that should be shown in the 'Problems' tab; \c nil if we should use the standard problems.html file
...
/// The delegate object for the compiler. The delegate is NOT RETAINED.
