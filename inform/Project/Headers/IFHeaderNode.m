...
@implementation IFHeaderNode {
    ...
    NSPoint position;
    /// The frame for this node, including all it's children
    NSRect frame;
    ...
    NSMutableArray<IFHeaderNode*>* children;
...
+ (void) initialize {
	...
	pointSize = [[NSUserDefaults standardUserDefaults] doubleForKey: IFHeaderPointSize];
}
